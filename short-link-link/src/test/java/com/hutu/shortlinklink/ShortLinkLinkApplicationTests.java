...
class ShortLinkLinkApplicationTests {
    ...
    void testSendWithTag() {
        // 测试带TAG的消息发送
        eventPublisher.publishWithTag(RocketMQConstant.TOPIC_SHORT_LINK_CREATE
        ...
        System.out.println("已发送带TAG的消息到: " + RocketMQConstant.TOPIC_SHORT_LINK_CREATE + ":" + RocketMQConstant.TAG_SHORT_LINK_ADD_LINK);
    }
